...
namespace KOL_HoangThuyLinh
{
    public class myfunc
    {
        ...
        public IPagedList<tblNews> FilterContent(string fromdate, string todate, string key, int status,
        ...
        public IPagedList<tblHome> GetNewsByType(int IdType, int page = 1, int pageSize = 20)
        {
            using (var conn = new MySqlConnection(ConnectionString))
            {
                conn.Open();
        ...
        public IPagedList<tblHome> GetNewsHome(int page, int pagesize = 10)
        {
            using (var conn = new MySqlConnection(ConnectionString))
            {
                conn.Open();
        ...
        public IPagedList<tblHome> GetVideoCategory(int page, int pageSize)
        {
        ...
        public IPagedList<tblHome> GetNewsCategory(int page, int pageSize)
        {
        ...
        public IPagedList<tblGallery> GetGalleryCategory(int page, int pageSize)
        {
        ...
        public IPagedList<tblGallery> GetListGallery(int page = 1, int pageSize = 20, string name = "")
        {
            using (var conn = new MySqlConnection(ConnectionString))
            {
                conn.Open();
        ...
        public IPagedList<tblGalleryDT> GetListGalleryDT(int id, int page = 1, int pageSize = 10, string name = "")
        {
            using (var conn = new MySqlConnection(ConnectionString))
            {
                conn.Open();
